...
export declare function buildFetchInfiniteScrollExtendedResponseAssertDelegate<BeforeT, ResponseDataT>(assertBeforeT: sd.AssertDelegate<BeforeT>, response: AssertFunc<ResponseDataT>): sd.AssertDelegate<FetchInfiniteScrollExtendedResponse<BeforeT, ResponseDataT>>;
