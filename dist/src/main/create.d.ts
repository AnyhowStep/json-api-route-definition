...
export declare function create<RawParamT, ParamT extends sd.Param<RawParamT>, QueryT, BodyT, ResponseT, AccessTokenT extends sd.AccessTokenType | undefined, MethodT extends sd.MethodLiteral, NewBodyT, ResponseDataT>(route: sd.Route<RawParamT, ParamT, QueryT, BodyT, ResponseT, AccessTokenT, MethodT>, body: AssertFunc<NewBodyT>, response: AssertFunc<ResponseDataT>): CreateRoute<RawParamT, ParamT, QueryT, NewBodyT, AccessTokenT, ResponseDataT>;
